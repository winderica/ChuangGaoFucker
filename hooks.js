...
function generateData() {
    ...
    var beganPoint = "30.508692|114.408546";
    var endPoint = "30.514006|114.432624";
    var points = ["30.508692, 114.408546", "30.509981, 114.408303", "30.511087, 114.408132", "30.511424, 114.410362", "30.510868, 114.416998", "30.510521, 114.420856", "30.513120, 114.421127", "30.515302, 114.421338", "30.514605, 114.427742", "30.514145, 114.430993", "30.514006, 114.432624"];
    var coordinate = [];
    for (var i = 0; i < points.length; i++) {
        var point = points[i].split(', ');
        coordinate.push({
            "a": +point[0] + ((i === 0 || i === points.length - 1) ? 0 : Math.random() / 10e6),
            "o": +point[1] + ((i === 0 || i === points.length - 1) ? 0 : Math.random() / 10e6),
            "v": 1,
            "s": 0,
            "t": 0,
            "ac": 0
